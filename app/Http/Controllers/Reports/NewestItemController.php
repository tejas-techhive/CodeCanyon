...
class NewestItemController extends Controller
{
    public function index(Request $request, $author_name = null)
    {
        $items = NewItems::query();
        ...
        return view('main_reports.newest-item', compact('items', 'searchTerm', 'sortOrder', 'startDate', 'endDate'));
    }
}
