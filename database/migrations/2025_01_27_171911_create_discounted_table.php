...
return new class extends Migration
{
    ...
    {
        Schema::create('discounted', function (Blueprint $table) {
            ...
            $table->string('last_update')->nullable(); // this is key feautres div
            $table->string('item_id')->nullable();
            // this is key feautres div
    ...
    {
        Schema::dropIfExists('discounted');
    }
};
