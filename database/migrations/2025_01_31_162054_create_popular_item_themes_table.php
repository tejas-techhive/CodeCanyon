...
return new class extends Migration
{
    ...
    {
        Schema::create('popular_item_themes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('theme_category_id')->nullable();
            $table->foreign('theme_category_id')->references('id')->on('theme_forest_categories');
    ...
    {
        Schema::dropIfExists('popular_item_themes');
    }
};
