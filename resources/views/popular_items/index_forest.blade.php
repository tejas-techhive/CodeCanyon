...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('theme.popular') }}" method="GET" class="mb-4">
            <div class="row">
                <!-- Category Filter -->
                <div class="col-md-3">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Category:</strong> {{ $item->forest_category->slug }}</p>
                ...
                <tbody>
                    @foreach ($popularItems as $key => $item)
                        <tr>
                            ...
                            <td>${{ $item->price }}</td>
                            <td>{{ $item->trending }}</td>
                            {{-- <td>{{ $item->forest_category->slug }}</td> --}}
                            <td>{{ $item->sales }}</td>
